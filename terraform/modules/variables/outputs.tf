...
output "ssl_certificate_basename" {
  value = lookup(var.ssl_certificate_basename, var.environment)
}

output "ssl_certificate_key_basename" {
  value = lookup(var.ssl_certificate_key_basename, var.environment)
}
